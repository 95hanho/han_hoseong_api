...
CREATE TABLE `hhs_menu` (
  ...
  KEY `menu_quick_idx` (`quick_id`),
  CONSTRAINT `menu_quick` FOREIGN KEY (`quick_id`) REFERENCES `hhs_quick` (`quick_id`),
...
-- Dump completed on 2025-02-07 17:53:35
